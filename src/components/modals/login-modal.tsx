...
import { signInWithEmailAndPassword, GoogleAuthProvider, signInWithRedirect, getRedirectResult, type UserCredential } from 'firebase/auth';
    ...
    getRedirectResult(auth)
      ...
      .catch((error) => {
        if (error.code === 'auth/popup-blocked') {
            setError("El pop-up de Google fue bloqueado por el navegador. Por favor, habilita las ventanas emergentes.");
